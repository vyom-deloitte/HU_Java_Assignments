...
public class SampleDataHandling {
    public static void main(String[] args) {
        try {
            Scanner scan = new Scanner(new FileReader("C:\\Users\\tbhattacharjee\\Desktop\\Assignments\\HU_JAVA_TRACK\\src\\File_Handling\\SampleData.csv"));
    ...
    public static void writeInSelectedStudent(ArrayList<Student> students) {
        try {
            PrintWriter writer = new PrintWriter(new File("C:\\Users\\tbhattacharjee\\Desktop\\Assignments\\HU_JAVA_TRACK\\src\\File_Handling\\SelectedStudent.csv"));
